...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar da Ana" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou a Ana Gabrielly_</p>
        <h1>Eu ensino Programação</h1>
        <p>Sou do ensino médio e ensino programação para estudantes do Ensino
